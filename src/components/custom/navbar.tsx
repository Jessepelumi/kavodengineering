...
export const Navbar = () => {
  return (
    <aside className="px-5 flex justify-between items-center py-3 lg:px-10">
      ...
      <button className="relative overflow-hidden text-[14px] bg-secondary-500 py-2 px-4 rounded-3xl transition-all duration-500 ease-in-out before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-brand-500 before:transition-all before:duration-500 before:ease-in-out hover:before:w-full hover:text-base-white">
